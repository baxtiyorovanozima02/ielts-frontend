    ...
    const sendMessage = async (text) => {
        ...
        try {
            ...
            setMessages(prev => [...prev, {
                role: 'assistant',
                content: serverError || "⚠️ Xatolik yuz berdi. Internet aloqangizni tekshiring va qayta urinib ko'ring.",
            }]);
        } finally {
            setLoading(false);
        }
                    ...
                    <div style={s.sidebar}>
                        ...
                        <div style={s.sideInfo}>
                            ...
                            <p style={s.sideInfoText}>
                                Claude AI asosida ishlaydi. IELTS bo'yicha barcha savollarga javob beradi.
                            </p>
                        </div>
                    </div>
