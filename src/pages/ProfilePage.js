            ...
            <main style={styles.main}>
                ...
                <div style={styles.card}>
                    <div style={styles.cardHeader}>
                        <h2 style={styles.cardTitle}>Shaxsiy ma'lumotlar</h2>
                        <button
                            onClick={() => setEditing(!editing)}
                            style={styles.editBtn}
                        >
                            {editing ? 'Bekor qilish' : '✏️ Tahrirlash'}
                        </button>
                    </div>
                    ...
                    <div style={styles.field}>
                        ...
                        {editing ? (
                            ...
                            <div style={styles.value}>
                                {user?.phone_number || <span style={{ color: 'var(--text-muted)' }}>Kiritilmagan</span>}
                            </div>
                        )}
                    </div>
                ...
                {/* Subscription card */}
                <div style={styles.card}>
                    <h2 style={styles.cardTitle}>Obuna</h2>
                    <div style={styles.subCard}>
                        <div>
                            <div style={styles.subName}>
                                {user?.is_premium ? '⭐ Premium tarif' : '🆓 Bepul tarif'}
                            </div>
